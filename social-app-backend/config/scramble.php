...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'REST API for the Social App. All endpoints are prefixed with `/v1`. Authenticate with the bearer token returned by `/v1/auth/login` or `/v1/auth/register`.',
    ],
     ...
     * ],
     */
    // Document bearer auth automatically — routes behind `auth:api` get the
    // Bearer scheme applied, public routes (login/register/health) are left
    // open. The "Try it" panel in /docs/api can then pre-fill the token.
